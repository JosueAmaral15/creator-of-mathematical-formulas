...
approximate_value, index_expected = binary_search_to_find_miniterm_from_dict(margin_of_error_difference, truth_table_product_list) # Achamos o minitermo, que seria a seleção de variáveis que devem ser operandos de uma operação de multiplicação.
final_result += approximate_value
list_of_algebraic_literal_parts = choice_enabler(index_expected, list(data.keys()))
