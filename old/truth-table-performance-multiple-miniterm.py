...
data = {
    ...
    "cos_brl": 0.022496208,
    "cos_usdt_inverse(usdt_coss)": 258.999999,
    "cos_usdt": 0.003864,
...
while margin_of_error_difference > tolerance and final_result + approximate_value < expected_result and (count < operation_limit or not ENABLE_OPERATION_LIMIT):
